...
#define APP_PAD_EMUL_LEFT_THUMB_LEFT	(VK_LEFT)
#define APP_PAD_EMUL_LEFT_THUMB_RIGHT	(VK_RIGHT)
#define APP_PAD_EMUL_LEFT_THUMB_UP		(VK_UP)
#define APP_PAD_EMUL_LEFT_THUMB_DOWN	(VK_DOWN)
#define APP_PAD_EMUL_BUTTON_ALT_A		('1')
...
#define APP_PAD_EMUL_BUTTON_A			('1')
#define APP_PAD_EMUL_BUTTON_B			('4')
#define APP_PAD_EMUL_BUTTON_X			('2')
#define APP_PAD_EMUL_BUTTON_Y			('3')
...
#define APP_PAD_EMUL_BUTTON_RIGHT_SHOULDER	(VK_SPACE)
